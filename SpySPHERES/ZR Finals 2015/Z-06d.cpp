...
void loop(){
	...
	can_take_a_picture_no_mirror = ((mirrorTimeRemaining==0)&(energy>action_energy)&(photos_taken<=1)
	...
	must_upload_pictures = (photos_taken>1)
	                    |( (photos_taken==1)&(((energy<action_energy)&(distance_to_dark>0.2f))|(mirrorTimeRemaining>0)|(TIME>=163)) )
